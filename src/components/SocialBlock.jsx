...
const SocialBlock = ({ className = '' }) => {
  return (
    ...
    >
      ...
      >
        <Image src="/images/social/max.svg" alt="icon" width={30} height={30} />
      </Link>
      <Link
        target="_blank"
        href={telegramLink}
      ...
      >
        <Image src="/images/social/telegram.svg" alt="icon" width={30} height={30} />
      </Link>
      <Link
        href={`mailto:${email}`}
        sx={{
      ...
      >
        <Image src="/images/social/email.svg" alt="icon" width={30} height={30} />
      </Link>
    </Box>
  );
};
